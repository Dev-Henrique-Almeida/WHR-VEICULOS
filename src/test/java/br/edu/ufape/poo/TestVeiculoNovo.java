...
class TestVeiculoNovo {
	...
	void findValorByVeiculoNovo() {
		...
		// VeiculoNovo vu = new VeiculoNovo(10000, 20000, true, new Modelo("Fiat",
		// "Uno", "Motor d'agua", 10000, "Branco", 2012, 10, 4, 120, true, "Gasolina" ),
		// true);
		// VeiculoNovo vu2 = new VeiculoNovo(150000, 250000, false, new
		// Modelo("Chevrolet", "Camaro", "V6", 0, "Amarelo", 2022, 100, 2, 300, true,
		// "Alcool" ), true);
		// VeiculoNovo vu3 = new VeiculoNovo(300000, 400000, false, new Modelo("BMW",
		// "I8", "V8", 0, "Preto", 2022, 150, 4, 330, true, "Diesel" ), false);
	...
	void findVendidoByVeiculoNovo() {
		...
		// VeiculoNovo vu = new VeiculoNovo(101, 500, false, new Modelo("Gol",
		// "carrinhooo", "motoe foda", 100, "rosinha", 2022, 10, 4, 10, true, "Disel"
		// ),"100km", true, true);
		// VeiculoNovo vu2 = new VeiculoNovo(3243, 342, true, new Modelo("Gol",
		// "carrinhooo", "motoe foda", 100, "rosinha", 2022, 10, 4, 10, true, "Disel"
		// ),"100km", true, true);
		// VeiculoNovo vu3 = new VeiculoNovo(1234201, 32, false, new Modelo("Irinel",
		// "carrinhooo", "motoe foda", 100, "rosinha", 2022, 10, 4, 10, true, "Disel"
		// ),"100km", true, true);
	...
	void findGarantiaByVeiculoNovo() {
		 ...
		 * VeiculoNovo vu = new VeiculoNovo(101, 500, false, new Modelo("Gol",
		 * "carrinhooo", "motoe foda", 100, "rosinha", 2022, 10, 4, 10, true, "Disel"
		 * ),"100km", true, true); VeiculoNovo vu2 = new VeiculoNovo(3243, 342, true,
		 * new Modelo("Gol", "carrinhooo", "motoe foda", 100, "rosinha", 2022, 10, 4,
		 * 10, true, "Disel" ),"100km", true, true); VeiculoNovo vu3 = new
		 * VeiculoNovo(1234201, 32, false, new Modelo("Irinel", "carrinhooo",
	...
	/*
	 * @Test void deleteVeiculoByVeiculoNovo() { VeiculoNovo vu3 = new
	 * VeiculoNovo(300000, 400000, false, new Modelo("BMW", "I8", "V8", 0, "Preto",
	 * 2022, 150, 4, 330, true, "Diesel" ), false); cvn.save(vu3); List<VeiculoNovo>
	 * veiculos = cvn.findAll(); for(VeiculoNovo f: veiculos) {
