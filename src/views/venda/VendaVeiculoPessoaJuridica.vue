<template >
    <div>
        <template v-if="tela === 1">
            <v-container>
                ...
                <v-card>
                    ...
                    <v-data-table v-model="cliente" :headers="headersClienteJuridico" :items="dessertsClienteJuridico"
        ...
        <template v-if="tela ===2">
            <v-container>
                <v-card color="grey darken-4">
                    <v-container>
                        ...
                        <h2>Cliente </h2>
                        <template>
                            <v-data-table :headers="headersClienteJuridico" :items="cliente" hide-default-footer
                                class="elevation-1"> </v-data-table>
                        </template>
                        <br />
                        <h2>Veiculo </h2>
            ...
            <template>
                <div class="text-center">
                    <v-btn class="ma-2" :loading="loading" :disabled="loading" color="secondary" @click="volta">Editar
                    </v-btn>
