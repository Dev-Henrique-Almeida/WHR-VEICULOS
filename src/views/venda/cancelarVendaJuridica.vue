            ...
            <v-container>
                <v-card color="grey darken-4">
                    <v-container>
                        ...
                        <h2> Cliente: </h2>
                        <template>
                            <v-data-table :headers="headersClienteJuridico" :items="venda" hide-default-footer
                                class="elevation-1">
                            </v-data-table>
                        </template>
                        <br />
...
export default {
    ...
    methods: {
        ...
        cancelarVenda() {
            ...
            CadastroOrdemVendaPessoaJuridicaService.cancelarVenda(this.selected[0].id).then(
                response => {
